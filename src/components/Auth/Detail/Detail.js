                ...
                <form className='second-portion' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className='input-login-field'>
                        ...
                        <div className='mobile'>
                            <input className='input-field2' type="text" placeholder='Mobile Number' name="mobile" {...register("mobile", { required: "mobile number is required", pattern: { value: /^\d{9}$/, message: "This is not a valid mobile number" } })}></input>
