...
5. **Logo Changes**:
   ...
   <img width="929" alt="logo changes and navbar re-coloured" src="https://github.com/chikoondoj/QueueManagement-main/releases/tag/v1.0">
6. **HomePage Colour Changes**:
   -Changes to the colour of the class "card" at the https://github.com/chikoondoj/QueueManagement-main/releases/tag/v1.0 in order to make the shops pop out for user view.
   -Adding ligher colours to the backgroung allows the shop or Class "card" to be the main view with its darker colours.
   <img width="926" alt="homepage colour changes" src="https://github.com/chikoondoj/QueueManagement-main/releases/tag/v1.0">
...
**before**
   - ![Screenshot (11)](https://github.com/chikoondoj/QueueManagement-main/releases/tag/v1.0)
   - 
